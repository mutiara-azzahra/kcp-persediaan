    ...
    <div class="row mt-5">
        <div class="col-lg-12 pb-3">
            ...
            <div class="card" style="padding: 10px;">
                <div class="card-body">
                    <strong>Tata Cara Proses Nilai Persediaan Non AOP</strong><br>
                    <ul>
                        ...
                        <table class="table table-hover table-bordered table-sm bg-light table-striped" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Pembelian Non</th>
                                    <th class="text-center">Retur Non</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ number_format($p->retur_non, 0, ',', '.') }}</td>
